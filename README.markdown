...
This directory contains source files for the Pedi language morphology
...
-   <https://giellalt.uit.no/lang/nso/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Pedi language morphology and dictionaries,
you need:
...
The Pedi language sources can be acquired using [giella SVN
