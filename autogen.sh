...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_nso to login script."
...
# the current dir:
if   test x${GTLANG_nso} = x ; then
	echo "WARNING: The variable \${GTLANG_nso} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_nso} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_nso} has the value:"
	echo "  ${GTLANG_nso}"
